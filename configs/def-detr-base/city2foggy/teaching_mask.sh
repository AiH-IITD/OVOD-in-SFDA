#!/bin/bash
#PBS -N dru_bs2_fnd_cs_dru
#PBS -l select=1:ncpus=4:ngpus=1
#PBS -l walltime=120:0:00
#PBS -o pbs_logs/fnd_cs_bs2_dru.log
#PBS -e pbs_logs/fnd_cs_bs2_dru_error.log
...
OUTPUT_DIR=./outputs/def-detr-base/city2foggy/teaching_mask
...
--random_seed 42 \
--resume /home/s_shashi/scratch/Repos/FMA_PNP/DRU/outputs/def-detr-base/city2foggy/source_only_fnd_same_hyperparam/model_best.pth |& tee tee_logs/fnd_bs2_dru.txt